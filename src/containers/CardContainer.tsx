...
function CardContainer({
  ...
  return (
    <Card
      className={`flex border-none w-[198px] flex-col gap-3 rounded-4xl md:w-[217px] lg:w-[365px] lg:gap-5 xl:w-[416px] ${className}`}
    >
      ...
      {/* Title below image */}
      <CardTitle className="text-base !font-normal lg:text-2xl xl:text-3xl">
        {title}
      </CardTitle>
    </Card>
  )

        ...
        <div className="flex flex-col gap-13 md:gap-24">
          <div className="flex flex-col gap-6 md:flex-row md:justify-center">
            <div className="flex flex-col gap-6 md:flex-1">
              <p>
                This blog post is a little meta—in the best way possible.
                I&apos;m building a personal profile website, and I&apos;m
                blogging about the process on the very site I&apos;m creating.
                It&apos;s a full-circle moment that feels both exciting and
                surreal: designing, developing, and documenting all in one
                place.
              </p>
              <p>
              ...
              <p>
                ...
                development workflow. I&apos;ve already completed the core UI
                and have my Figma files ready, which I&apos;ll be sharing in
                future posts.
              </p>
            </div>
          ...
          <div className="flex flex-col gap-6">
            ...
            <p>
              ...
              site to feel clean, modern, and personal—something that reflects
              my style while staying functional.
            </p>
            <p>
            ...
            <ul>
              <li>
                🎨 Figma Design File &#8211; includes light/dark mode layouts
            ...
            <ul>
              ...
              <li>
                Responsive Layouts: Tailored designs for desktop, laptop,
                tablet, and mobile
              </li>
              <li>
          ...
          <div className="flex flex-col gap-6">
            ...
            <ul>
              ...
              <li>
                The Project Page will use Next.js dynamic routing, allowing me
                to load different content based on the selected project.
              </li>
              <li>
          ...
          <div className="flex flex-col gap-6">
            ...
            <p>
              When using Jira, I wanted to be intentional about how I set it up.
              I didn&apos;t just want a task tracker—I wanted a system that
              reflects the creative and technical phases of building a portfolio
              site. Here&apos;s how I structured it:
            </p>
            ...
            <p>
              ...
              mark key milestones. Each version represents a distinct phase in
            ...
            <p>
              These labels help me quickly filter tasks by theme, especially
              when working on parallel versions of the same component. For
              example, a button might have separate design tasks for light and
              dark mode, each tagged accordingly.
            </p>
            <p>

      ...
      {loading ? (
        ...
        <div className="flex flex-col gap-13 md:gap-24">
          <div className="flex flex-col gap-6 md:flex-row md:justify-center">
            <div className="flex flex-col gap-6 md:flex-1">
              ...
              <p>
                ...
                TypeScript, React, Next.js, and Tailwind CSS—along with a suite
                of tools to enforce code quality, consistency, and developer
                productivity.
              </p>
            </div>
          ...
          <div className="flex flex-col gap-6">
            ...
            <ul>
              <li>
                <span className="underline">Material UI:</span> Offers a
                polished component library and strong accessibility, but
                customizing styles—especially with Emotion—can be tedious. It
                often feels like working against the framework when trying to
                implement a unique design system.
              </li>
              <li>
                <span className="underline">Bootstrap:</span> Great for quick
                layout scaffolding, but its design language is highly
                opinionated. Making Bootstrap components feel modern and
                tailored usually requires heavy overrides or complete rewrites.
              </li>
            </ul>
            <p>
              These tools were valuable for learning layout, responsiveness, and
              component structure—but they didn&apos;t offer the level of
              control I wanted for this project.
            </p>
            <h3>✨ Why I Chose ShadCN UI</h3>
            <p>
              For this project, I copied and customized components from ShadCN
              UI, which is built on Radix UI and Tailwind CSS. This gave me a
              strong foundation of accessible, headless components with full
              styling control.
            </p>
            <ul>
              <li>
                <span className="underline">Tailwind-first: </span>ShadCN
                components are styled using Tailwind utility classes, making
                them easy to adapt to my design tokens
              </li>
              <li>
                <span className="underline">Accessibility baked in: </span>
                Built on Radix primitives, they handle keyboard navigation, ARIA
                roles, and focus management out of the box
              </li>
              <li>
                <span className="underline">Modular and composable: </span>
                Each component is isolated and easy to extend or refactor
              </li>
              <li>
            ...
            <p>
              ...
              base—then tailored the visuals, structure, and behavior to match
              my design system and project architecture.
            </p>
            <h3>🎨 UI Philosophy</h3>
            <ul>
              <li>
              ...
              <li>
                <span className="underline">
                  Minimal customization friction:
                </span>{" "}
          ...
          <div className="flex flex-col gap-6">
            ...
            <p>
              ...
              you&apos;re building a SaaS product, a portfolio site, or a
              reusable UI library, this setup provides a clean, extensible
              foundation designed to accelerate development without compromising
              quality.
            </p>
            <p>
              It was kickstarted with Create Next App, laying the groundwork
              with Next.js for routing and server-side rendering, React for
              component-based architecture, and TypeScript for type safety and
              enhanced developer ergonomics. From there, the focus was on
              crafting a robust development environment that enforces code
              quality and streamlines the workflow—making the project not just
              functional, but clean, scalable, and enjoyable to work on.
            </p>
            <h3>🧱 What&apos;s Inside</h3>
            <ul>
              ...
              <li>
                Automated code quality enforcement using ESLint, Prettier,
          ...
          <div className="flex flex-col gap-6">
            ...
            <ul>
              ...
              <li>
                Validated and formatted files are re-added to the commit to
                ensure consistency.
              </li>
            </ul>
            <p>
              This setup guarantees that every commit meets the quality bar—like
              having a mini CI pipeline running locally. It prevents bad
              commits, speeds up development, and boosts confidence that the
              code is always in a deployable state.
            </p>
            <h3>🧠 Import Sorting Strategy</h3>
            <p>
              To keep import statements clean and logically grouped, the project
              uses @ianvs/prettier-plugin-sort-imports, which integrates
              directly with Prettier. This plugin automatically organizes
              imports without requiring a separate linting pass.
            </p>
            <h4>Why It Works</h4>
            <ul>
              <li>
            ...
            <p>
              Other import-sorting tools were considered, but didn&apos;t align
              as well with the project&apos;s workflow:
            </p>
            <ul>
              <li>
          ...
          <div className="flex flex-col gap-6">
            ...
            <p>
              Typography plays a central role in the app&apos;s visual identity.
              I integrated the full SF Pro font family, including:
            </p>
            <ul>
            ...
            <h3>🌗 Theme System</h3>
            <p>
              The app supports light and dark modes using a custom theme
              context:
            </p>
            <ul>
            ...
            <p>
              This system ensures a dynamic, user-friendly UI that adapts to
              user preferences.
            </p>
          </div>
          <div className="flex flex-col gap-6">
            ...
            <p>
              To keep the project modular and scalable, I organized the src
              folder as follows:
            </p>
            <Table>
            ...
            <p>
              Even the empty folders are intentional—they&apos;re placeholders
              for future expansion and help maintain a clean, intuitive
              architecture.
            </p>
          </div>
          <div className="flex flex-col gap-6">
            ...
            <p>
              ...
              ShadCN-inspired UI components, recreated from scratch to align
              with my architecture and design system. These components are
              modular, accessible, and styled entirely with Tailwind CSS, making
              them easy to integrate and extend.
            </p>
            <div className="flex flex-col gap-6 lg:flex-row">
              <div className="flex flex-col gap-6 lg:w-3/4">
                ...
                <ul>
                  ...
                  <li className="pt-5">
                    <span className="underline">Modular and reusable:</span>{" "}
                    Easy to drop into any interface
                  </li>
                  <li className="pt-5">
                ...
                <p>
                  This library gives me a solid foundation for building
                  polished, responsive UIs with consistent styling and
                  behavior—perfectly aligned with my Tailwind-based design
                  system.
                </p>
              </div>
            ...
            <div className="flex flex-col gap-6 lg:flex-row">
              <div className="relative flex w-full items-center justify-center lg:w-1/2">
                ...
                />
                <Button className="absolute bottom-4 left-4">
                  Second Tab that contains Accordion, Alert, TextArea,
                  RadioGroup, Dialog and Combobox
                </Button>
              </div>
          ...
          <div className="flex flex-col gap-6">
            ...
            <p>
              The main branch contains the essential scaffolding for the app:
            </p>
            <ul>
              <li>
            ...
            <ul>
              ...
              <li>
                <span className="underline">Clean Git history:</span>{" "}
                Architecture changes stay isolated from component
                experimentation
              </li>
              <li>
            ...
            <p>
              The starter-cmp branch builds on top of main and introduces a
              fully custom component library inspired by ShadCN UI:
            </p>
            <ul>
              <li>
            ...
            <p>
              This branch acts as a sandbox for UI development—ideal for
              building out interfaces quickly and consistently.
            </p>
          </div>
          <div className="flex flex-col gap-6">
            <h2>Challenges & What I&apos;d Do Differently</h2>
            <p>
              Building this template was incredibly rewarding, but it
              wasn&apos;t without its hurdles. Here are a few challenges I ran
              into—and how I&apos;d approach them differently in future
              iterations:
            </p>
            ...
            <ul>
              <li>
                ...
                consistently across screen sizes and themes took time and
                careful tuning.
              </li>
              <li>
              ...
              <li>
                ...
                configuring them to work harmoniously—especially across
                different environments—was more time-consuming than expected.
              </li>
              <li>
                <span className="underline">
              ...
              <li>
                <span className="underline">Branch management:</span>{" "}
                Maintaining the starter-cmp branch alongside the main branch
                introduced some friction when syncing updates or refactoring
                shared logic.
              </li>
            </ul>
          </div>
          <div className="flex flex-col gap-6">
            ...
            <p>
              ...
              product, this setup gives you the tools to succeed. Clone the
              repo, switch to starter-cmp, and start crafting your UI with
              confidence.
            </p>
          </div>
        </div>

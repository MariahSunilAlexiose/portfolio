        ...
        <div className="flex flex-col gap-13 md:gap-24">
          <div className="flex flex-col gap-6 md:flex-row md:justify-center">
            <div className="flex flex-col gap-6 md:flex-1">
              <p>
                ...
                facilitates food ordering and delivery. It connects customers
                with restaurants, allowing users to browse menus, place orders,
                and track deliveries. The system is divided into three main
                components:
              </p>
              <ul>
          ...
          <div className="flex flex-col gap-6">
            ...
            <p>
              ...
              research and competitive analysis to identify common pain points
              and expectations in food discovery apps. By studying existing
              platforms and analyzing user reviews, I uncovered key trends that
              guided the design of the Dish Detail Page.
            </p>
            <h3>🔍 Key Observations</h3>
            <ul>
              <li>
                <span className="underline">Health-Conscious Behavior:</span>{" "}
                Many users rely on calorie tracking apps and expect nutritional
                transparency when browsing food options.
              </li>
              <li>
                <span className="underline">Allergy Awareness:</span> Popular
                food platforms often lack clear allergen labeling, leading to
              ...
              <li>
                ...
                religious, or culinary reasons. Ingredient visibility is a
                growing expectation.
              </li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li>
                <span className="underline">Accessibility:</span> Ensured all
                info is screen-reader friendly and mobile responsive
              </li>
            </ul>
          ...
          <div className="flex flex-col gap-6">
            ...
            <p>
              ...
              intuitive, and scalable across devices. Navigation is handled
              using React Router, enabling clean route management and dynamic
              page transitions.
            </p>
            <p>
              To safeguard user-specific pages like profile, orders, and
              reviews, the app uses a custom ProtectedRoute component. This
              ensures that only authenticated users can access sensitive
              routes—such as /myorders, /profile, and /address—by checking for
              valid login credentials (via JWT tokens) and redirecting
              unauthenticated users to the login page.
            </p>
            <h3>🧠 Global State Management with StoreProvider</h3>
            <p>
              At the heart of the frontend lies the StoreProvider, a React
              Context Provider that centralizes shared state and logic across
              the app. It wraps the application and exposes values and functions
              through the StoreContext, making them accessible to any component.
            </p>
            ...
            <ul>
              ...
              <li>
                Restaurants from /api/restaurant, enriched with related dishes
                and cuisines
              </li>
            </ul>
            <p>🔁 Backend Sync</p>
            ...
            <ul>
              ...
              <li>
                <span className="underline">Order Management:</span> Place
                orders and track their status.
              </li>
              <li>
          ...
          <div className="flex flex-col gap-6">
            ...
            <p>
              I built the backend using Node.js and Express.js, with MongoDB
              Atlas as the cloud-hosted database. It manages all the core parts
              of my application—users, dishes, restaurants, orders, reviews,
              categories, and cuisines. For security, I&apos;ve implemented
              authentication using JSON Web Tokens (JWT) for users and a static
              token system for admins. Image uploads are handled using Multer, a
              middleware for file handling in Express.
            </p>
            <h3>🔗 How I Connect to the Database</h3>
            <p>
              The backend connects to MongoDB Atlas using a secure connection
              string. The password is stored in an environment variable to keep
              it protected. Once the connection is successful, the server logs a
              confirmation message. This connection is established using
              Mongoose, a Node.js ODM library, before any API requests are
              handled.
            </p>
            <p>
            ...
            <div className="flex gap-6">
              ...
              <div className="flex flex-col">
                ...
                <p className="pt-5">
                  Users are authenticated using JSON Web Tokens (JWT). When a
                  user logs in, the backend generates a token using the
                  jsonwebtoken library. This token must be included in future
                  requests and is verified to extract the user&apos;s ID and
            ...
            <div className="flex gap-6">
              ...
              <div className="flex flex-col">
                ...
                <ul>
                  <li>
                    Creating, updating, and deleting dishes, categories,
                ...
                <p>
                  These routes are protected by admin token-based middleware.
                </p>
              </div>
            </div>
            ...
            <ul>
              <li>
                <span className="underline">Storage:</span> Images are saved in
            ...
            <ul>
              ...
              <li>
                For user updates, the logic is more flexible. Instead of
                requiring all fields, it ensures that at least one valid field
                is provided. This allows partial updates while still maintaining
                data integrity.
              </li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li>
                Displays images by accessing /images/[filename] served by
                Express
              </li>
            </ul>
            <p>Admin Panel:</p>
          ...
          <div className="flex flex-col gap-6">
            ...
            <p>
              ...
              structure. The goal is to fetch data from the backend, display it
              in a table, and provide actions like view, update, or delete.
            </p>
            <p>
              Each page component (like Categories, Dishes, Users, etc.) does
              the following:
            </p>
            <ul>
              <li>
          ...
          <div className="flex flex-col gap-6">
            ...
            <p>
              Building DashBite was a rewarding experience, but like any
              project, it came with its share of challenges and trade-offs.
              Reflecting on the process, here are a few areas I&apos;d approach
              differently in future iterations:
            </p>
            ...
            <ul>
              <li>
                ...
                The admin panel currently uses a static token for
                authentication, which is hardcoded and separate from the user
                authentication system (which uses JWT).
              </li>
              <li>
                <span className="underline">Why It&apos;s a Concern:</span>{" "}
                While this method was quick to implement, it lacks scalability
                and security. Static tokens can be easily compromised and
                don&apos;t support role-based access or session expiration.
              </li>
              <li>
                <span className="underline">
                  <span className="underline">
                ...
                admins, implementing role-based access control (RBAC), and
                adding token expiration and refresh mechanisms for better
            ...
            <ul>
              <li>
                <span className="underline">Challenge:</span> Without direct
                user interviews or usability testing, design decisions were
                based on assumptions and competitive analysis.
              </li>
              <li>
                <span className="underline">What I&apos;d Do Differently:</span>{" "}
                I&apos;d incorporate lightweight usability testing—such as
                remote task-based feedback or A/B testing—to validate design
                choices and uncover blind spots.
              </li>
            </ul>
            ...
            <ul>
              <li>
                ...
                lacked robust validation and graceful error messaging,
                especially in form inputs and API responses.
              </li>
              <li>
                <span className="underline">What I&apos;d Do Differently:</span>{" "}
            ...
            <ul>
              <li>
                ...
                new features were added mid-development, which affected
                timelines and focus.
              </li>
              <li>
                <span className="underline">What I&apos;d Do Differently:</span>{" "}
                I&apos;d define a stricter MVP scope and use a feature backlog
                to prioritize enhancements post-launch.
              </li>
            </ul>
          </div>
        </div>
